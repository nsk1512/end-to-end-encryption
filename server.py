...
log(
f'New connection failed from {client.address}, No public key
provided (username: {client.username})')
return False
else:
...
log(
f'Accepted new connection from {client.address}
...
# Send info about sender and the message he sent to other
clients
sender_information = client.username_header +
client.raw_username
